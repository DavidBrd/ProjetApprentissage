...
print("Entrainement du classifier K_Means pour obtenir les centres des clusters entrainés")
classifier_k_means.fit(patches)
clusters, centers = classifier_k_means.classifications, classifier_k_means.centers

print("Patching des données de train et de test pour le passage au perceptron multi-classe")
